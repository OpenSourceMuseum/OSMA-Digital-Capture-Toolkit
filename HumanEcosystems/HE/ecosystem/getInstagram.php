...
if($mainLng==999 && $mainLng==999){
	...
	for($i=0 ; $i<count($words) ; $i++){
		...
		$qq = $qq . "/media/recent?client_id=PUT YOUR INSTAGRAM API CLIENT ID HERE";
		$url[] = $qq;
	}

} else {

	$url[] = "https://api.instagram.com/v1/media/search?lat=" . $mainLat . "&lng=" . $mainLng . "&distance=5000&client_id=PUT YOUR INSTAGRAM API CLIENT ID HERE";
