...
\Codebird\Codebird::setConsumerKey('PUT YOUR TWITTER CONSUMER KEY HERE', 'PUT YOUR TWITTER CONSUMER SECRET HERE'); // static, see 'Using multiple Codebird instances'

$cb = \Codebird\Codebird::getInstance();

$cb->setToken('PUT YOUR TWITTER ACCESS TOKEN HERE', 'PUT YOUR TWITTER ACCESS TOKEN SECRET HERE');
...
\Codebird\Codebird::setBearerToken('PUT YOUR TWITTER BEARER TOKEN HERE');
